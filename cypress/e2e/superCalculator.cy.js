...
describe("Calculator App", function () {
  ...
  operators.forEach((operator) => {
    it(`positive numbers with operator ${operator}`, function () {
      ...
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("have.text", generic.calculateResult(3, 5, operator));
      cy.calculate(60, 700, operator);
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("have.text", generic.calculateResult(60, 700, operator));
    });
    ...
    it(`negative numbers with operator ${operator}`, function () {
      ...
      cy.get("form")
        ...
        .should(
          "have.text",
          generic.calculateResult(-30000, -400000, operator),
        );
      cy.calculate(-999, -444, operator);
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("have.text", generic.calculateResult(-999, -444, operator));
    });
    ...
    it(`positive and a negative number with operator ${operator}`, function () {
      ...
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("have.text", generic.calculateResult(400000, -3, operator));
      cy.calculate(-500, 3, operator);
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("have.text", generic.calculateResult(-500, 3, operator));
    });
    ...
    it(`number and zero with operator ${operator}`, function () {
      ...
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("contain.text", generic.calculateResult(2, 0, operator));
      cy.calculate(0, 888, operator);
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("contain.text", generic.calculateResult(0, 888, operator));
    });
    ...
    it(`zero and number with operator  ${operator}`, function () {
      ...
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("contain.text", generic.calculateResult(0, 899, operator));
      cy.calculate(999, 0, operator);
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("contain.text", generic.calculateResult(999, 0, operator));
    });
    ...
    it(`an integer and a decimal with operator  ${operator}`, function () {
      ...
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("have.text", generic.calculateResult(799, 0.0003, operator));
    ...
    it(`two decimals with operator  ${operator}`, function () {
      ...
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("have.text", generic.calculateResult(0.4, 0.009, operator));
    });
    it(`empty characters with operator  ${operator}`, function () {
      cy.calculate(" ", " ", operator);
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("have.text", generic.calculateResult(" ", " ", operator));
    });
    it(`two strings with operator  ${operator}`, function () {
      cy.calculate("test", "test1", operator);
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("have.text", generic.calculateResult("test", "test", operator));
    });
    it(`a string and a number with operator  ${operator}`, function () {
      cy.calculate("test2", 999, operator);
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("have.text", generic.calculateResult("test", 30000, operator));
      cy.calculate(776, "test3", operator);
      cy.get("form")
        .find('[class="ng-binding"]')
        .should("have.text", generic.calculateResult(776, "test3", operator));
    });
  });
